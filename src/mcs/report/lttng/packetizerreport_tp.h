...
#define TRACEPOINT_INCLUDE "mcs/report/lttng/packetizerreport_tp.h"

#if !defined(MCS_REPORT_LTTNG_PACKETIZERREPORT_TP_H_) || defined(TRACEPOINT_HEADER_MULTI_READ)
#define MCS_REPORT_LTTNG_PACKETIZERREPORT_TP_H_
