...
#define TRACEPOINT_INCLUDE "ac/report/lttng/encoderreport_tp.h"

#if !defined(AC_REPORT_LTTNG_ENCODERREPORT_TP_H_) || defined(TRACEPOINT_HEADER_MULTI_READ)
#define AC_REPORT_LTTNG_ENCODERREPORT_TP_H_
